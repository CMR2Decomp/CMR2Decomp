...
```
call "<msvc600_dir>/VC98/bin/cl.exe" CMR2Decomp/*.cpp /Fe"build/CMR2.exe" /O2 /DNDEBUG /Zi /Gz /MD /link user32.lib gdi32.lib advapi32.lib ole32.lib msacm32.lib third_party/dx7sdk-7001/lib/dxguid.lib third_party/dx7sdk-7001/lib/dinput.lib third_party/dx7sdk-7001/lib/ddraw.lib /DEBUG /PDB:"build\CMR2.pdb" /SUBSYSTEM:WINDOWS
```
