...
void __stdcall FormatGapToLeader(int iLeaderGap, unsigned int param_2, unsigned char param_3, int param_4, int param_5, void *param_6, unsigned int param_7, const char *pcNegPosSymbol, int param_9);
